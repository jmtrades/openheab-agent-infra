...
<div class=foot>
  ...
  app.get('/', (req, res, next) => {
    ...
    res.json({
      ...
      layer_count: 83,
      mcp_tool_count_approx: (() => { try { return require('./primitives/mcp_server').TOOLS.length; } catch { return 167; } })(),
      install_mcp: '/install-mcp',
      mcp_manifest_wellknown: '/.well-known/mcp.json',
      revenue_model: '/v1/revenue-model',
      revenue_layers: 14,
