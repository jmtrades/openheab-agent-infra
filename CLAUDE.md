...
| Metric | Value |
|---|---|
| Primitive modules | **255** in `src/primitives/` |
| HTTP routes | **1,830+** registered |
| Cron jobs | 21 scheduled (82 wired via dispatcher) |
| MCP tools | 149 at `/mcp` |
| Architecture layers | 57 |
| Tests | 210 passing + route smoke (0 5xx across 812+ GET routes) |
